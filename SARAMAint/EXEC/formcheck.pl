...
#  or 
#  (5) If number of residues considering both the chains exceed 995
#  or
#  (6) If residue number exceeds 3 digit (999)
#  or 
#  (7) If multiple occupancies are found for atoms
#  or
#  (8) If redundant amino-acid identities are found for the same residue position
...
{
print "=======================================================================================================\n";
print "\nThe input pdb file contains residues with sequence numbers exceeding three digits (999) \n\n";
print "\nThe program will exit\n\n";
print "=======================================================================================================\n";
print OUTF "stop\n";
exit;
...
#==============================================================
# If redundant amino-acid identities are found for the same residue position
#==============================================================

open (FORMP,">formp.pdb");
